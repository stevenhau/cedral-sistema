...
<!--[if lt IE 9]> <script type="text/javascript" src="public/js/modernizr.custom.js"></script> <![endif]-->
<!-- /STYLES -->
...
<div class="ryker_tm_all_wrap" data-magic-cursor="show" data-color="brown"> 
	...
	<div class="ryker_tm_settings">
		...
		<div class="wrapper">
			...
			<ul class="cursor">
				...
				<li><a class="hide" href="#"><img class="svg" src="public/img/svg/arrow.svg" alt="" /></a></li>
			</ul>
		</div>
	</div>
	<!-- /SETTINGS -->
	...
	<div class="ryker_tm_modalbox">
		<div class="box_inner">
			<div class="close">
				<a href="#"><img class="svg" src="public/img/svg/cancel.svg" alt="" /></a>
			</div>
	...
	<div class="ryker_tm_topbar">
		<div class="topbar_inner">
			<div class="logo">
				<a href="#"><img src="public/img/logo/dark.png" alt="" /></a>
			</div>
			<div class="menu">
				<div class="list">
					<ul class="anchor_nav">
				...
				<div class="content">
					<div class="texts">
						...
						<div class="short_skills">
							...
							<div class="icons">
								<ul>
									<li><img class="svg" src="public/img/svg/html.svg" alt="" /></li>
									<li><img class="svg" src="public/img/svg/css.svg" alt="" /></li>
									<li><img class="svg" src="public/img/svg/angular.svg" alt="" /></li>
									<li><img class="svg" src="public/img/svg/bootstrap.svg" alt="" /></li>
								</ul>
							</div>
						</div>
					</div>
					<div class="avatar">
						<div class="image" data-img-url="public/img/about/4.jpg"></div>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="container">
				<div class="about_inner">
					<div class="left wow fadeInLeft" data-wow-duration="1.5s">
						<div class="image">
							<img src="public/img/thumbs/1-1.jpg" alt="" />
							<div class="main" data-img-url="public/img/about/2.jpg"></div>
							<div class="experience">
								<h3 class="year" data-img-url="public/img/about/2.jpg">7</h3>
								<div id="circle">
									<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="300px" height="300px" viewBox="0 0 300 300" enable-background="new 0 0 300 300" xml:space="preserve">
										...
										<g>
											...
											<text fill="#000">
												<textpath xlink:href="#circlePath">Years of best and successful work experience</textpath>
											</text>
										</g>
									</svg>
								</div>
					...
					<div class="right wow fadeInRight" data-wow-duration="1.5s">
						...
						<div class="signature">
							<img src="public/img/signature.png" alt="" />
						</div>
						...
						<ul class="grid">
							<li class="grid-item wow fadeInUp" data-wow-duration="1.5s">
								<div class="list_inner">
									<img class="svg" src="public/img/svg/design.svg" alt="" />
									<h3 class="title">Design</h3>
								</div>
							</li>
							<li class="grid-item wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.2s">
								<div class="list_inner">
									<img class="svg" src="public/img/svg/code.svg" alt="" />
									<h3 class="title">Development</h3>
								</div>
							</li>
							<li class="grid-item wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.2s">
								<div class="list_inner">
									<img class="svg" src="public/img/svg/award.svg" alt="" />
									<h3 class="title">Quality</h3>
								</div>
							</li>
							<li class="grid-item wow fadeInUp" data-wow-duration="1.5s">
								<div class="list_inner">
									<img class="svg" src="public/img/svg/tools.svg" alt="" />
						...
						<ul class="gallery_zoom">
							<li class="wow fadeInUp" data-wow-duration="1.5s">
								<div class="list_inner">
									<div class="image">
										<img src="public/img/thumbs/1-1.jpg" alt="" />
										<div class="main" data-img-url="public/img/portfolio/1.jpg"></div>
									</div>
							...
							<li class="wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.2s">
								<div class="list_inner">
									<div class="image">
										<img src="public/img/thumbs/1-1.jpg" alt="" />
										<div class="main" data-img-url="public/img/portfolio/2.jpg"></div>
									</div>
									<div class="overlay"></div>
									<div class="details">
										<h3>Sweet Cherry</h3>
							...
							<li class="wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.4s">
								<div class="list_inner">
									<div class="image">
										<img src="public/img/thumbs/1-1.jpg" alt="" />
										<div class="main" data-img-url="public/img/portfolio/3.jpg"></div>
									</div>
									<div class="overlay"></div>
									<div class="details">
										<h3>Red Nike</h3>
							...
							<li class="wow fadeInUp" data-wow-duration="1.5s">
								<div class="list_inner">
									<div class="image">
										<img src="public/img/thumbs/1-1.jpg" alt="" />
										<div class="main" data-img-url="public/img/portfolio/6.jpg"></div>
									</div>
									<div class="overlay"></div>
									<div class="details">
										<h3>Blue Lemon</h3>
											...
											<div class="detailbox">
												<ul>
													...
													<li>
														...
														<ul class="share">
															<li><a href="#"><img class="svg" src="public/img/svg/social/facebook.svg" alt="" /></a></li>
															<li><a href="#"><img class="svg" src="public/img/svg/social/twitter.svg" alt="" /></a></li>
															<li><a href="#"><img class="svg" src="public/img/svg/social/instagram.svg" alt="" /></a></li>
															<li><a href="#"><img class="svg" src="public/img/svg/social/dribbble.svg" alt="" /></a></li>
															<li><a href="#"><img class="svg" src="public/img/svg/social/tik-tok.svg" alt="" /></a></li>
														</ul>
													</li>
												</ul>
											</div>
												...
												<li>
													<div class="list_inner">
														<div class="my_image">
															...
															<div class="main" data-img-url="public/img/portfolio/7.jpg"></div>
														</div>
													</div>
												</li>
												<li>
													<div class="list_inner">
														<div class="my_image">
															<img src="public/img/thumbs/4-2.jpg" alt="" />
															<div class="main" data-img-url="public/img/portfolio/8.jpg"></div>
														</div>
													</div>
												</li>
												<li>
													<div class="list_inner">
														<div class="my_image">
															<img src="public/img/thumbs/4-2.jpg" alt="" />
															<div class="main" data-img-url="public/img/portfolio/9.jpg"></div>
														</div>
													</div>
												</li>
											</ul>
							...
							<li class="wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.2s">
								<div class="list_inner">
									<div class="image">
										<img src="public/img/thumbs/1-1.jpg" alt="" />
										<div class="main" data-img-url="public/img/portfolio/5.jpg"></div>
									</div>
									<div class="overlay"></div>
									<div class="details">
										<h3>Pantone</h3>
									...
									<a class="ryker_tm_full_link zoom" href="public/img/portfolio/5.jpg"></a>
								</div>
							</li>
							<li class="wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.4s">
								<div class="list_inner">
									<div class="image">
										<img src="public/img/thumbs/1-1.jpg" alt="" />
										<div class="main" data-img-url="public/img/portfolio/4.jpg"></div>
									</div>
									<div class="overlay"></div>
									<div class="details">
										<h3>New Telephone</h3>
									...
									<a class="ryker_tm_full_link zoom" href="public/img/portfolio/4.jpg"></a>
								</div>
							</li>
						</ul>
					</div>
	...
	<div class="ryker_tm_section">
		<div class="ryker_tm_video">
			<div class="background">
				<div class="image jarallax" data-speed="0" data-img-url="public/img/hero/1.jpg"></div>
				<div class="overlay"></div>
			</div>
			<div class="content">
				<div class="container">
				...
				<div class="testimonials_list">
					<div class="wrapper owl-carousel">
						<div class="wr_in item">
							<div class="list_inner">
								<ul class="stars">
									<li><img class="svg" src="public/img/svg/star.svg" alt="" /></li>
									<li><img class="svg" src="public/img/svg/star.svg" alt="" /></li>
									<li><img class="svg" src="public/img/svg/star.svg" alt="" /></li>
									<li><img class="svg" src="public/img/svg/star.svg" alt="" /></li>
									<li><img class="svg" src="public/img/svg/star.svg" alt="" /></li>
								...
								<div class="avatar">
									<div class="image" data-img-url="public/img/about/2.jpg"></div>
								</div>
								<img class="svg myquote" src="public/img/svg/quote.svg" alt="" />
							</div>
						</div>
						<div class="wr_in item">
							<div class="list_inner">
								...
								<div class="avatar">
									<div class="image" data-img-url="public/img/about/1.jpg"></div>
								</div>
								<img class="svg myquote" src="public/img/svg/quote.svg" alt="" />
							</div>
						</div>
						<div class="wr_in item">
							<div class="list_inner">
								...
								<div class="avatar">
									<div class="image" data-img-url="public/img/about/3.jpg"></div>
								</div>
								<img class="svg myquote" src="public/img/svg/quote.svg" alt="" />
							</div>
						</div>
				...
				<div class="news_list">
					<ul>
						<li class="wow fadeInUp" data-wow-duration="1.5s">
							<div class="list_inner">
								<div class="image">
									<img src="public/img/thumbs/4-3.jpg" alt="" />
				...
				<div class="short_info wow fadeInUp" data-wow-duration="1.5s">
					<ul>
						<li>
							<div class="list_inner">
								<div class="logo">
									<img class="svg" src="public/img/svg/location-2.svg" alt="" />
								</div>
								<div class="info">
									<h3>Location</h3>
						...
						<li>
							<div class="list_inner">
								<div class="logo">
									<img class="svg" src="public/img/svg/telephone-2.svg" alt="" />
								</div>
								<div class="info">
									<h3>Phone</h3>
						...
						<li>
							<div class="list_inner">
								<div class="logo">
									<img class="svg" src="public/img/svg/email-2.svg" alt="" />
								</div>
								<div class="info">
									<h3>Mail</h3>
	...
	<!-- AUDIO FOR CLICK -->
	<audio id="audio1"><source src="public/audio/1.mp3"></audio>
	<audio id="audio2"><source src="public/audio/2.mp3"></audio>
	<!-- /AUDIO FOR CLICK -->
...
<!--[if lt IE 10]> <script type="text/javascript" src="public/js/ie8.js"></script> <![endif]-->	
