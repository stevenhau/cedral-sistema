            ...
            <div class="header">
                <div class="logo logo-dark">
                    <a href="index.html">
                        ...
                        <img class="logo-fold" src="public/img/logo/logo-fold.png" alt="Logo">
                    </a>
                </div>
                <div class="logo logo-white">
                    <a href="index.html">
                        <img src="public/img/logo/logo-white.png" alt="Logo">
                        <img class="logo-fold" src="public/img/logo/logo-fold-white.png" alt="Logo">
                    </a>
                </div>
                <div class="nav-wrap">
                    <ul class="nav-left">
